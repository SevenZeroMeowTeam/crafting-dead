...
public class HomingBigArrow extends AbstractArrow {
  ...
  public HomingBigArrow(EntityType<? extends HomingBigArrow> type, LivingEntity owner, Level level,
      ItemStack itemStack) {
    super(type, owner, level, itemStack, itemStack);
  ...
  protected void defineSynchedData(SynchedEntityData.Builder builder) {
    ...
    builder.define(DATA_HOMING_TARGET, Optional.empty());
  }
  ...
  public Entity getHomingTarget() {
    ...
    if (targetId.isPresent() && this.level() instanceof ServerLevel serverLevel) {
