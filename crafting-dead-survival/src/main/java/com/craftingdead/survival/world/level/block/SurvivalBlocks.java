...
public class SurvivalBlocks {
  ...
  public static final DeferredRegister<Block> deferredRegister =
      DeferredRegister.create(BuiltInRegistries.BLOCK, CraftingDeadSurvival.ID);

  public static final DeferredHolder<Block, ? extends Block> MILITARY_LOOT =
      deferredRegister.register("military_loot",
          () -> new LootBlock(BlockBehaviour.Properties.of()
              .strength(5.0F, 5.0F)
              .noOcclusion()));

  public static final DeferredHolder<Block, ? extends Block> MEDICAL_LOOT =
      deferredRegister.register("medic_loot",
          () -> new LootBlock(BlockBehaviour.Properties.of()
              .strength(5.0F, 5.0F)
              .noOcclusion()));

  public static final DeferredHolder<Block, ? extends Block> CIVILIAN_LOOT =
      deferredRegister.register("civilian_loot",
          () -> new LootBlock(BlockBehaviour.Properties.of()
              .strength(5.0F, 5.0F)
              .noOcclusion()));

  public static final DeferredHolder<Block, ? extends Block> RARE_CIVILIAN_LOOT =
      deferredRegister.register("civilian_rare_loot",
          () -> new LootBlock(BlockBehaviour.Properties.of()
              .strength(5.0F, 5.0F)
              .noOcclusion()));

  public static final DeferredHolder<Block, ? extends Block> POLICE_LOOT =
      deferredRegister.register("police_loot",
          () -> new LootBlock(BlockBehaviour.Properties.of()
              .strength(5.0F, 5.0F)
              .noOcclusion()));

  public static final DeferredHolder<Block, ? extends Block> MILITARY_LOOT_GENERATOR =
  ...
  public static final DeferredHolder<Block, ? extends Block> MEDICAL_LOOT_GENERATOR =
  ...
  public static final DeferredHolder<Block, ? extends Block> CIVILIAN_LOOT_GENERATOR =
  ...
  public static final DeferredHolder<Block, ? extends Block> RARE_CIVILIAN_LOOT_GENERATOR =
  ...
  public static final DeferredHolder<Block, ? extends Block> POLICE_LOOT_GENERATOR =
  ...
  private static LootGeneratorBlock lootGenerator(Supplier<? extends Block> lootBlock,
